...
from autoforge.data.paths import PROJECT_ROOT
...
AUTOFORGE_ROOT = PROJECT_ROOT

# Debug log file path (keep in .autoforge dir at root)
DEBUG_LOG_FILE = AUTOFORGE_ROOT / ".autoforge" / "orchestrator_debug.log"
