...
import type { TenantId, ResourceId, BookingId, UserId } from '@/convex-api';
...
export const MOCK_BOOKING_ID = 'k17book789' as BookingId;
...
export const mockBookings = [
    {
        _id: 'k17book001' as BookingId,
        _creationTime: Date.now(),
        tenantId: MOCK_TENANT_ID,
        resourceId: 'k17res001' as ResourceId,
        userId: MOCK_USER_ID,
        organizationId: undefined,
    ...
    {
        _id: 'k17book002' as BookingId,
        _creationTime: Date.now(),
        tenantId: MOCK_TENANT_ID,
        resourceId: 'k17res002' as ResourceId,
        userId: MOCK_USER_ID,
        organizationId: undefined,
