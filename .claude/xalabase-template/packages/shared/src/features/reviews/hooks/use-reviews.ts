...
function transformReview(convexReview: any): Review {
    return {
        id: convexReview._id,
        ...
        body: convexReview.text, // Map 'text' to 'body'
