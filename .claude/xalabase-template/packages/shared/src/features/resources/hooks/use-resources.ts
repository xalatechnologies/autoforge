...
export function useDeleteResource(): {
    ...
    return {
        deleteResource: (id: ResourceId) => mutation({ id }),
    };
}
...
export function usePublishResource(): {
    ...
    return {
        publishResource: (id: ResourceId) => mutation({ id }),
    };
}
...
export function useUnpublishResource(): {
    ...
    return {
        unpublishResource: (id: ResourceId) => mutation({ id }),
    };
}
